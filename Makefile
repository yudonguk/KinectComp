...
OPROS_INC=C:/OPRoS/OprosDevelopment/IDE/CommonLibrary/include
OPROS_LIB=C:/OPRoS/OprosDevelopment/IDE/CommonLibrary/lib
...
INC = /I "$(OPROS_INC)" -IC:/OPRoS/OprosDevelopment/IDE/CommonLibrary/include/DeviceAPI

CPP=cl.exe

CPP_PROJ=/O2 /Oi $(INC) /GL /D "WIN32" /D "_WINDOWS" /D "NRELEASE" /D "MAKE_COMPONENT_DLL" /D "_USRDLL" /D "_WINDLL" /D "_AFXDLL" /D "_UNICODE" \
